...
public enum AdministratorLocators implements ILocator {
    ...
    AdministratorLocators(final String elementName,
    ...
    @Override
    public AdministratorLocators modify(final String parameter) {
